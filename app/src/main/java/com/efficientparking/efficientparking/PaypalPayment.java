...
public class PaypalPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startService(intent);
        buttonPagaOra = (Button)findViewById(R.id.buttonPagaOra);
        editAmount = (EditText)findViewById(R.id.editAmount);

        buttonPagaOra.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void processPayment() {
        ...
        PayPalPayment paypalPayment = new PayPalPayment(new BigDecimal(100),"USD",
                "Paga il tempo di parcheggio", PayPalPayment.PAYMENT_INTENT_SALE);
        Intent intent = new Intent(this, PaymentActivity.class);
        intent.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION,config);
        intent.putExtra(PaymentActivity.EXTRA_PAYMENT, (Parcelable) paypalPayment);
